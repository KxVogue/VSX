 ...
 */
package io.codex.vsx.plugins.impl
...
import io.codex.vsx.activities.EditorActivity
import io.codex.vsx.app.rootView
import io.codex.vsx.core.EventManager
import io.codex.vsx.core.MenuManager
import io.codex.vsx.core.PanelManager
import io.codex.vsx.core.components.DraggableFloatingPanel
import io.codex.vsx.editor.VSXEditor
import io.codex.vsx.file.wrapFile
import io.codex.vsx.keyboard.CommandPaletteManager
import io.codex.vsx.keyboard.model.Command
...
import io.codex.vsx.plugins.Editor
import io.codex.vsx.plugins.PluginContext
import io.codex.vsx.plugins.Workspace
import io.codex.vsx.plugins.command.EditorCommand
import io.codex.vsx.plugins.dialog.DialogButtonClickListener
import io.codex.vsx.plugins.editor.Position
import io.codex.vsx.plugins.event.EventListener
import io.codex.vsx.plugins.event.EventType
import io.codex.vsx.plugins.menu.MenuItem
import io.codex.vsx.plugins.network.HttpResponse
import io.codex.vsx.plugins.panel.ComposeFactory
import io.codex.vsx.plugins.panel.Panel
import io.codex.vsx.plugins.panel.ViewFactory
import io.codex.vsx.plugins.panel.ViewUpdater
...
class PluginContextImpl(
    ...
    override fun addMenu(menuItem: MenuItem) {
        ...
        menuManager.addMenu(
            io.codex.vsx.core.menu.MenuItem(
                menuItem.title,
                menuItem.id,
                visible = true,
                enabled = true,
