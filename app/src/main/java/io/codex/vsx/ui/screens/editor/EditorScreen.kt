...
package io.codex.vsx.ui.screens.editor
...
import io.codex.vsx.activities.Editor.LocalCommandPaletteManager
import io.codex.vsx.activities.Editor.LocalEditorDrawerState
import io.codex.vsx.activities.Editor.LocalEditorSnackbarHostState
import io.codex.vsx.compose.ui.EditorTab
import io.codex.vsx.compose.ui.dialog.ConfirmDialog
import io.codex.vsx.core.EventManager
import io.codex.vsx.core.ai.Gemini
import io.codex.vsx.core.settings.Settings.Editor.rememberColorScheme
import io.codex.vsx.core.settings.Settings.Editor.rememberCurrentEditor
import io.codex.vsx.core.settings.Settings.Editor.rememberDeleteIndentOnBackspace
import io.codex.vsx.core.settings.Settings.Editor.rememberDeleteLineOnBackspace
import io.codex.vsx.core.settings.Settings.Editor.rememberEditorTextActionWindowExpandThreshold
import io.codex.vsx.core.settings.Settings.Editor.rememberFontFamily
import io.codex.vsx.core.settings.Settings.Editor.rememberFontLigatures
import io.codex.vsx.core.settings.Settings.Editor.rememberFontSize
import io.codex.vsx.core.settings.Settings.Editor.rememberIndentSize
import io.codex.vsx.core.settings.Settings.Editor.rememberLineNumber
import io.codex.vsx.core.settings.Settings.Editor.rememberStickyScroll
import io.codex.vsx.core.settings.Settings.Editor.rememberUseTab
import io.codex.vsx.core.settings.Settings.Editor.rememberWordWrap
import io.codex.vsx.core.settings.Settings.File.rememberLastOpenedFile
import io.codex.vsx.core.settings.Settings.General.rememberFollowSystemTheme
import io.codex.vsx.core.settings.Settings.General.rememberIsDarkMode
import io.codex.vsx.core.settings.Settings.Monaco
import io.codex.vsx.core.settings.Settings.Monaco.rememberAcceptSuggestionOnCommitCharacter
import io.codex.vsx.core.settings.Settings.Monaco.rememberAcceptSuggestionOnEnter
import io.codex.vsx.core.settings.Settings.Monaco.rememberCursorBlinkingStyle
import io.codex.vsx.core.settings.Settings.Monaco.rememberCursorStyle
import io.codex.vsx.core.settings.Settings.Monaco.rememberFolding
import io.codex.vsx.core.settings.Settings.Monaco.rememberGlyphMargin
import io.codex.vsx.core.settings.Settings.Monaco.rememberLetterSpacing
import io.codex.vsx.core.settings.Settings.Monaco.rememberLineDecorationsWidth
import io.codex.vsx.core.settings.Settings.Monaco.rememberLineNumbersMinChars
import io.codex.vsx.core.settings.Settings.Monaco.rememberMatchBrackets
import io.codex.vsx.core.settings.Settings.Monaco.rememberMonacoTheme
import io.codex.vsx.core.settings.Settings.Monaco.rememberWordBreak
import io.codex.vsx.core.settings.Settings.Monaco.rememberWrappingStrategy
import io.codex.vsx.editor.TextActionsWindow
import io.codex.vsx.editor.VSXEditor
import io.codex.vsx.editor.addBlockComment
import io.codex.vsx.editor.addSingleComment
import io.codex.vsx.editor.listener.OnExplainCodeListener
import io.codex.vsx.editor.listener.OnImportComponentListener
import io.codex.vsx.editor.textaction.EditorTextActionItem
import io.codex.vsx.editor.textaction.actionItems
import io.codex.vsx.editor.textaction.editorTextActionWindow
import io.codex.vsx.file.File
import io.codex.vsx.file.extension
import io.codex.vsx.keyboard.CommandPaletteManager
import io.codex.vsx.keyboard.createKeyEvent
import io.codex.vsx.keyboard.model.toShortcut
import io.codex.vsx.plugins.DialogManager
import io.codex.vsx.resources.R
import io.codex.vsx.ui.LocalToastHostState
import io.codex.vsx.ui.components.keyboard.CommandPalette
import io.codex.vsx.ui.screens.editor.ai.CodeExplanationSheet
import io.codex.vsx.ui.screens.editor.ai.ImportComponentsSheet
import io.codex.vsx.ui.screens.editor.components.Symbols
import io.codex.vsx.ui.screens.editor.components.view.CodeEditorView
import io.codex.vsx.utils.launchWithProgressDialog
import io.codex.vsx.plugins.event.KeyPressEvent
